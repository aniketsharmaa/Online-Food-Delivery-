...
const ResturantCard = (props) => {
  ...
  return (
    <div className="res-card">
      <img alt="image load ni hua" className="res-logo"  src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.cloudinaryImageId}/>
    
      <h3>{resData.name}</h3>
      <h6>{resData.cuisines.join(", ")}</h6>
      <h6>Rating {resData.avgRating}</h6>
      <h6>{resData.costForTwo/100}</h6>
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        ...
        <ResturantCard resData ={resObj.data}/>
        <ResturantCard resData ={resObj.data}/>
        <ResturantCard resData ={resObj.data}/>
        <ResturantCard resData ={resObj.data}/>
        <ResturantCard resData ={resObj.data}/>

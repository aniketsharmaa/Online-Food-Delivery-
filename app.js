...
const ResturantCard = (props) => {
  ...
  return (
    <div className="res-card">
      <img alt="image load ni hua" className="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + resData.data.cloudinaryImageId} />
